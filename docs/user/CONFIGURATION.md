...
This document describes all configuration options and settings available in the Napoleon BBQ custom integration.
...
```yaml
service: napoleon_bbq.example_service
target:
