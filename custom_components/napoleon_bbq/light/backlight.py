"""Knob backlight light entity for napoleon_bbq."""

from __future__ import annotations

from typing import TYPE_CHECKING, Any

from custom_components.napoleon_bbq.const import PROP_BRT_LVL, PROP_LCD_OFF, PROP_TYPE_BOOL, PROP_TYPE_INT
...
class NapoleonBBQBacklightLight(LightEntity, NapoleonBBQEntity):
