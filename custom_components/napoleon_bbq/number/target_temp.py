"""Target temperature number entities for napoleon_bbq."""
...
from custom_components.napoleon_bbq.const import PROP_TGT_TEMPS, PROP_TYPE_DECIMAL
...
class NapoleonBBQTargetTempNumberEntityDescription(NumberEntityDescription):
    """Entity description for a Napoleon BBQ target temperature number.
...
ENTITY_DESCRIPTIONS: tuple[NapoleonBBQTargetTempNumberEntityDescription, ...] = tuple(
    NapoleonBBQTargetTempNumberEntityDescription(
...
class NapoleonBBQTargetTempNumber(NumberEntity, NapoleonBBQEntity):
    """Number entity for setting a target temperature on a Napoleon BBQ probe.
    ...
    entity_description: NapoleonBBQTargetTempNumberEntityDescription
