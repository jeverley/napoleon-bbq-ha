"""Target humidity number for napoleon_bbq."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.napoleon_bbq.api import NapoleonBBQApiClientError
...
class NapoleonBBQHumidityNumber(NumberEntity, NapoleonBBQEntity):
